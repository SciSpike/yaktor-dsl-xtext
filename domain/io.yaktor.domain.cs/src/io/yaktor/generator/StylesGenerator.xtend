...
class StylesGenerator {
  ...
  def genStyles(IFileSystemAccess fsa, DomainModel spec) {
    var inc = spec.getInclusionType(InclusionCat::STYLES)
    if (inc != InclusionType::NONE) {
	  	fileUtil.generateFile(fsa, Constants::webAppBase, 'styles', 'alt.css', genAlt(), inc == InclusionType::PROTECTED)
	  	fileUtil.generateFile(fsa, Constants::webAppBase, 'styles', 'standard.css', genStandard(), inc == InclusionType::PROTECTED)
	  }
  }
