...
public class AccessPackageImpl extends EPackageImpl implements AccessPackage {
  ...
  /**
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRestService_SupportedDocumentTypes(), this.getRestDocumentType(), "supportedDocumentTypes", null, 0, -1, RestService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
